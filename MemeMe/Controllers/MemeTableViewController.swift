...
class MemeTableViewController: UITableViewController {
    ...
    @IBAction func addNewMeme(_ sender: Any) {
        ...
        let memeEditorVC = storyboard.instantiateViewController(withIdentifier: "newMeme")as! MemeEditorView
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let info = memes[indexPath.row]
        i = indexPath.row
        performSegue(withIdentifier: "selectRow" , sender: info)
    }
